...
function Home() {
  ...
  return (
    <article className="home flex min-h-[80vh] items-center justify-center gap-16 px-8">
        ...
        <div className="home__right-box min-w-[320px] max-w-[350px]">
              ...
              <div key={p.id} className="px-1">
                <div className="project__card-box">
                  ...
                  <div className="project__card-bottom-box">
                    ...
                    <Link to="/projects" className="project__card-link">
                      go_project-page
                    </Link>
                  </div>
                </div>
          ...
          <div className="home__game-box flex justify-center">
            ...
            >
              ...
              <div className="home__key-box grid grid-cols-3 gap-1 place-items-center">
            ...
            <Link to="/about" className="skip-btn flex">
              skip
            </Link>
          </div>
        </div>
      ...
      <div className="home__blurry-gradient-blue"></div>
      <div className="home__blurry-gradient-green"></div>
    </article>
  );
}
